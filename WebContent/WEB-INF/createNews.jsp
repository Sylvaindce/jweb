...
<title>Techsis, Creer News</title>
		...
		<div class="line">
			<div class="margin">
				<div class="s-12 l-12 margin-bottom">
					<div class="box">
						<form method="post" action="/jweb/createNews">
							<fieldset>
								<legend>Informations news</legend>
								<label>Title* </label> <input type="text" name="title" size="30"
									maxlength="30" /> <br /> <label>Content*</label> <input
									type="text" name="content" size="100" maxlength="500" /> <br />
								<p>${ form.result }</p>
							</fieldset>
